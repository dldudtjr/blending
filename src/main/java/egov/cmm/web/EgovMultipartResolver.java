package egov.cmm.web;

/*
 * Copyright 2001-2006 The Apache Software Foundation. Licensed under the Apache License, Version 2.0 (the ";License&quot;); you may not use this file
        ...
        for (Iterator<?> it = fileItems.iterator(); it.hasNext();) {
            ...
            if (fileItem.isFormField()) {
                ...
                if (fileItem.getSize() > 0) {
                    ...
                    LOGGER.debug("Found multipart file [{}] of size {} bytes with original filename [{}], stored {}", file.getName(), file.getSize(), file.getOriginalFilename(),
