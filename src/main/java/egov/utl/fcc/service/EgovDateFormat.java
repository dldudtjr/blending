...
public class EgovDateFormat {
     ...
     *
     * @param style
     *            날짜 스타일 (사용 가능한 값 : {@link DateFormat#FULL},
     *            {@link DateFormat#LONG}, {@link DateFormat#MEDIUM},
     ...
     *            {@link DateFormat#SHORT}, {@link DateFormat#DEFAULT})
     * @param timeStyle
     *            시간 스타일 (사용 가능한 값 : {@link DateFormat#FULL},
     *            {@link DateFormat#LONG}, {@link DateFormat#MEDIUM},
     *            {@link DateFormat#SHORT}, {@link DateFormat#DEFAULT})
     * @param date
     *            날짜 및 시간
     * @return 날짜 및 시간 문자열
     */
    public static String formatDateTime(int dateStyle, int timeStyle,
            Date date) {
