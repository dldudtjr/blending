...
public class EgovStringUtil {
    ...
    /**
     * 문자열을 다양한 문자셋(EUC-KR[KSC5601],UTF-8..)을 사용하여 인코딩하는 기능 역으로 디코딩하여 원래의 문자열을 복원하는 기능을 제공함 String temp = new String(문자열.getBytes("바꾸기전 인코딩"),"바꿀
     * 인코딩"); String temp = new String(문자열.getBytes("8859_1"),"KSC5601"); => UTF-8 에서 EUC-KR
     *
     * @param srcString
     *            - 문자열
     * @param srcCharsetNm
