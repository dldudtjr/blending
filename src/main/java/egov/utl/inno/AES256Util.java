...
public class AES256Util {
    ...
    public static Key AES256Util(String key) throws UnsupportedEncodingException {
        String iv;
        Key keySpecs;
    ...
    public static String encrypt(String str, String key) throws NoSuchAlgorithmException, GeneralSecurityException, UnsupportedEncodingException {
        ...
        c.init(Cipher.ENCRYPT_MODE, AES256Util(key), new IvParameterSpec(key.substring(0, 16).getBytes()));
    ...
    public static String decrypt(String str, String key) throws NoSuchAlgorithmException, GeneralSecurityException, UnsupportedEncodingException {
        Cipher c = Cipher.getInstance("AES/CBC/PKCS5Padding");
        c.init(Cipher.DECRYPT_MODE, AES256Util(key), new IvParameterSpec(key.substring(0, 16).getBytes()));
