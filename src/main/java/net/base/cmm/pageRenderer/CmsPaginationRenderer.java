...
public class CmsPaginationRenderer extends AbstractPaginationRenderer{

	public CmsPaginationRenderer() {



		this.firstPageLabel = "\t\t<a href=\"javascript:void(0);\" onclick=\"{0}({1});return false;\" class=\"wn-pg-prev\"><<</a>\n";
		this.previousPageLabel = "\t\t<a href=\"javascript:void(0);\" onclick=\"{0}({1});return false;\" class=\"page_prev\"><</a>\n";
		this.currentPageLabel = "\t\t<a href=\"javascript:void(0);\" class=\"wn-pg-num acitve\">{0}</a>\n";
		this.otherPageLabel = "\t\t<a href=\"javascript:void(0);\" class=\"wn-pg-num\" onclick=\"{0}({1});return false;\">{1}</a>\n";
		this.nextPageLabel = "\t\t<a href=\"javascript:void(0);\" onclick=\"{0}({1});return false;\" class=\"wn-pg-next\">></a>\n";
		this.lastPageLabel = "\t\t<a href=\"javascript:void(0);\" onclick=\"{0}({1});return false;\" class=\"wn-pg-next\">>></a>\n";
	}
	...
	public String renderPagination(PaginationInfo paginationInfo, String jsFunction) {
		...
		outStr.append("<div class=\"wn-pagination\">\n");
		// outStr.append("\t<ul>\n");
