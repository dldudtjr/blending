	...
	<aside class="sidebar">
       ...
       <nav class="sidebar-nav" id="brandLnb" style="display:none">
         <ul class="sidebar-menu no-icon icon-order">
           ...
           <li class="sidebar-menu-item"><a href="javascript:productLngLoc('introduce')">제품소개</a><i class="wn-icon check3">단계1</i></li>
           <li class="sidebar-menu-item"><a href="javascript:productLngLoc('detail')">제품상세</a><i class="wn-icon check3">단계2</i></li>
           <li class="sidebar-menu-item"><a href="javascript:productLngLoc('distribution')">유통현황</a><i class="wn-icon check3">단계3</i></li>
           <li class="sidebar-menu-item"><a href="javascript:productLngLoc('maketing')">마케팅 </a><i class="wn-icon check3">단계4</i></li>
         </ul>
       </nav>
     </aside>
