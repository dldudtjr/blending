  ...
  <div class="sidebar-main">
            ...
            <div class="detail-wrap">
              <div class="detail-wrap-left">
                ...
                <div class="mt-30">
                  <div class="form-field">
                    <h4 class="detail-wrap-title">Variant SKU/Style number<span>- 선택사항</span>
                      <div class="help-wrap">
                  ...
                  <div class="d-flex">
                    <div class="form-field">
                      ...
                      <div class="input-add add-right2">
                        <div class="custom-title wd-130">US Dollar</div>
                    ...
                    <div class="form-field">
                      ...
                      <div class="input-add add-right2">
                        <div class="custom-title wd-130">US Dollar</div>
                        <sf:input path="msrp" class="input-text" placeholder="48.00" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="mt-30">
                  ...
                  <div class="form-field">
                    <label class="radio">
	                  <sf:radiobutton path="bcdYn" class="input-text" value="Y" />
                      <span class="label">Yes</span>
                    </label>
                    <label class="radio">
                      <sf:radiobutton path="bcdYn" class="input-text" value="N" />
                ...
                <div class="mt-30">
                  <h4 class="detail-wrap-title">제품 패키지가 있습니까?<span>- 선택사항</span>
                    <div class="help-wrap">
                      <i class="wn-icon help">QnA</i>
                      <div class="help-cont">
                        <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                  ...
                  <div class="form-field">
                    <label class="radio">
                      <sf:radiobutton path="pkgYn" class="input-text" value="Y" />
                      <span class="label">Yes</span>
                    </label>
                    <label class="radio">
                      <sf:radiobutton path="pkgYn" class="input-text" value="N" />
                      <span class="label">No</span>
                    </label>
                  </div>
                </div>
                <div class="mt-30">
                  <h4 class="detail-wrap-title">패키지 규격<span>- 선택사항</span>
                    <div class="help-wrap">
                      <i class="wn-icon help">QnA</i>
                      <div class="help-cont">
                        <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                ...
                <div class="d-flex mt-30">
                  <div class="form-field">
                    <h4 class="detail-wrap-title">제품 용량<span>- 선택사항</span>
                      <div class="help-wrap">
                        <i class="wn-icon help">QnA</i>
                        <div class="help-cont">
                          <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                  ...
                  <div class="form-field">
                    <h4 class="detail-wrap-title">제품 무게<span>- 선택사항</span>
                      <div class="help-wrap">
                        <i class="wn-icon help">QnA</i>
                        <div class="help-cont">
                          <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                ...
                <div class="mt-30">
                  <h4 class="detail-wrap-title">카튼 박스가 있습니까?<span>- 선택사항</span>
                    <div class="help-wrap">
                      <i class="wn-icon help">QnA</i>
                      <div class="help-cont">
                        <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                  ...
                  <div class="form-field">
                    <label class="radio">
	                  <sf:radiobutton path="cartonYn" class="input-text" value="Y" />
                      <span class="label">Yes</span>
                    </label>
                    <label class="radio">
                      <sf:radiobutton path="cartonYn" class="input-text" value="N" />
                      <span class="label">No</span>
                    </label>
                  </div>
                </div>
                <div style="display: block;">
                  ...
                  <div class="d-flex mt-30">
                    <div class="form-field">
                      ...
                      <sf:input path="palletTi" class="input-text"  placeholder="Volume"  />
                    </div>
                    <div class="form-field">
                      <h4 class="detail-wrap-title">Pallet HI</h4>
                       <sf:input path="palletHi" class="input-text"  placeholder="무게"  />
                    </div>
                  </div>
                  <div class="d-flex mt-30">
                    <div class="form-field">
                      <h4 class="detail-wrap-title">Pallet 당 총 카튼 수</h4>
                      <sf:input path="cartonTot" class="input-text"   />
                    </div>
                    <div class="form-field"></div>
                  </div>
                </div>
                <div class="mt-30">
                  <h4 class="detail-wrap-title">인박스가 있습니까?<span>- 선택사항</span>
                    <div class="help-wrap">
                      <i class="wn-icon help">QnA</i>
                      <div class="help-cont">
                        <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                  ...
                  <div class="form-field">
                    <label class="radio">
	                    <sf:radiobutton path="inboxYn" class="input-text" value="Y" />
                      <span class="label">Yes</span>
                    </label>
                    <label class="radio">
                      <sf:radiobutton path="inboxYn" class="input-text" value="N" />
                      <span class="label">No</span>
                    </label>
                  </div>
                </div>
                ...
                <div class="mt-30">
                  <h4 class="detail-wrap-title">제품 유통기한이 있나요?<span>- 선택사항</span>
                    <div class="help-wrap">
                      <i class="wn-icon help">QnA</i>
                      <div class="help-cont">
                        <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                  ...
                  <div class="form-field">
                    <label class="radio">
                      <sf:radiobutton path="expireDtYn" class="input-text" value="Y" />
                      <span class="label">Yes</span>
                    </label>
                    <label class="radio">
                      <sf:radiobutton path="expireDtYn" class="input-text" value="N" />
                      <span class="label">No</span>
                    </label>
                  </div>
                  <div class="form-field">
...
<!--
                ...
                <div class="mt-30">
                  <h4 class="detail-wrap-title">제품 전성분이 있나요?<span>- 선택사항</span>
                    <div class="help-wrap">
                      <i class="wn-icon help">QnA</i>
                      <div class="help-cont">
                        <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                  ...
                  <div class="form-field">
                    <label class="radio">
                      <sf:radiobutton path="ingredientsYn" class="input-text" value="Y" />
                      <span class="label">Yes</span>
                    </label>
                    <label class="radio">
                      <sf:radiobutton path="ingredientsYn" class="input-text" value="N" />
                      <span class="label">No</span>
                    </label>
                  </div>
                  <div class="form-field">
	                  <sf:input path="ingredients" class="input-text" placeholder="제품 전성분을 입역하십시오. 콤마(,) 사용하여 분리" />
                  </div>
                </div>
                <div class="mt-30">
                  <h4 class="detail-wrap-title">제품 여양사실 라벨이 있나요?<span>- 선택사항</span>
                    <div class="help-wrap">
                      <i class="wn-icon help">QnA</i>
                      <div class="help-cont">
                        <span>세부내용 설명입니다. 세부내용 설명입니다.</span>
                  ...
                  <div class="form-field">
                    <label class="radio">
                      <sf:radiobutton path="labelYn" class="input-text" value="Y" />
                      <span class="label">Yes</span>
                    </label>
                    <label class="radio">
                      <sf:radiobutton path="labelYn" class="input-text" value="N" />
                      <span class="label">No</span>
                    </label>
                  </div>
                  <div class="form-field">
                    <div class="form-attach-file">
                      <input type="file" name="labelImg[]" id="labelImg" hidden="" accpet="image/*">
                      <label for="labelImg">
                        <span class="button bt-outline bt-blue2"><i class="wn-icon plus mr-5"></i>라벨 이미지</span>
                      </label>
