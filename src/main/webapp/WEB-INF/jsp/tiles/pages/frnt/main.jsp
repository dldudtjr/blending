...
<script src="<c:url value='/files/lib/crypto-js/aes.js'/>"></script>
<script src="<c:url value='/files/lib/crypto-js/sha256.js'/>"></script>
<script src="<c:url value='/files/lib/jquery/messagebox.js'/>"></script>
</head>
<body>
			...
			<div class="main-content main-bg">
				<div class="main-img">
					<div class="main-text-wrap">
						<span class="main-text-title">Gateway to Market</span> <span>글로벌 소비재 시장 진출을 위한 필수 관문</span> <a href="#">무료제품등록</a>
					</div>
				...
				<div class="main-form-wrap">
					<div class="main-form">
						<div class="main-form-img">
							<img src="/files/images/sample1.jpg" alt="">
						</div>
						<div class="main-form-text">
							<span class="main-form-title">커스텀 브랜드 페이지</span> <span>브랜드페이지를 꾸미고 제품의 특장점을 강조하여 매력 어필 자유로운 브랜드 및 제품 페이지 공유</span>
						</div>
					</div>
					<div class="main-form reverse">
						<div class="main-form-img">
							<img src="/files/images/sample2.jpg" alt="">
						</div>
						<div class="main-form-text">
							<span class="main-form-title">바이어 맞춤 큐레이션</span> <span>바이어가 필요로하는 필수 정보 위주 제품 쇼케이스 바이어 맞춤형 카테고리 큐레이션 및 필터링</span>
						</div>
					</div>
					<div class="main-form">
						<div class="main-form-img">
							<img src="/files/images/sample3.jpg" alt="">
						</div>
						<div class="main-form-text">
							<span class="main-form-title">다채널 제품 홍보 및 판매</span> <span>다양한 글로벌 바이어에게 직접 브랜드 제안 글로벌 마케팅 채널 구축</span>
						</div>
					</div>
				</div>
			...
			<div class="modal-content">
				...
				<div class="wn-modal-body pa-30">
					<div class="select-type">
						<a href="javascript:void(0)" class="active"> <img src="/files/images/brand.png" alt=""> <img src="/files/images/brand_bw.png" alt="">
							<p>Brand</p>
						</a> <a href="javascript:void(0)"> <img src="/files/images/buyer.png" alt=""> <img src="/files/images/buyer_bw.png" alt="">
							<p>Buyer</p>
						</a>
					</div>
